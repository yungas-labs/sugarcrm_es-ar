...
//END DON'T CONVERT
  ...
  'UPDATE_FIX_TXT' => 'Procura arreglar algunas cantidades no válidas introduciendo un decimal válido a partir del monto actual. Toda cantidad modificada es resguardada en el campo amount_backup de la base de datos. Si lo ejecutas y se notifican errores, no vuelvas a ejercutarlo sin restaurar antes desde el backup ya que puede éste puede sobreescribirse con los nuevos datos no válidos.',  'UPDATE_DOLLARAMOUNTS_TXT' => 'Actualiza los montos en U.S. Dólares para ventas basado en los tipos de cambio vigentes. Este valor es usado para el cálculo de Gráficos y el Listado de Montos de Divisas.',
  'UPDATE_CREATE_CURRENCY' => 'Creación de Nueva Moneda:',
  'UPDATE_VERIFY_FAIL' => 'Registro de Verificación de Error:',
  'UPDATE_VERIFY_CURAMOUNT' => 'Cantidad Actual:',
  'UPDATE_VERIFY_FIX' => 'Ejecutar Fijar daría',
  'UPDATE_INCLUDE_CLOSE' => 'Incluir Registros Terminados',
  'UPDATE_VERIFY_NEWAMOUNT' => 'Nueva Cantidad:',
  'UPDATE_VERIFY_NEWCURRENCY' => 'Nueva Moneda:',
  'UPDATE_DONE' => 'Terminado',
  'UPDATE_BUG_COUNT' => 'Errores Encontrados y Tratados de Resolver:',
  'UPDATE_BUGFOUND_COUNT' => 'Errores Encontrados:',
  ...
  'UPDATE_MERGE_TXT' => 'Combinar varias monedas en una sola moneda. Si hay múltiples registros de moneda para la misma moneda, debes combinarlas. Esto también combinará las monedas para todos los otros módulos.',
  ...
  'LBL_LEADS_SUBPANEL_TITLE' => 'Conductores',
  'LBL_PROJECTS_SUBPANEL_TITLE' => 'Proyectos',  
  'LBL_NEXT_STEP' => 'Próxima Etapa:',
  'LBL_LEAD_SOURCE' => 'Lugar de Origen:',
