...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'UpgradeWizard' => 'Asistente para Actualización',
    'Trackers' => 'Rastreadores',
    'TrackerPerfs' => 'Rastreador de Funcionamiento',
    'TrackerSessions' => 'Rastreador de Sesiones',
    'TrackerQueries' => 'Rastreador de Consultas',
    'FAQ' => 'FAQ',
    'Newsletters' => 'Noticias',
    'SugarFeed'=>'Sugar Feed',
    'KBDocuments' => 'Base de Conocimientos',
  ...
  array (
    '' => '',
    'Cold Call' => 'Llamada Telefónica Publicitaria',
    'Existing Customer' => 'Cliente Existente',
    'Self Generated' => 'Auto-Generado',
    'Employee' => 'Empleado',
    'Partner' => 'Socio',
    'Public Relations' => 'Relaciones Públicas',
    'Direct Mail' => 'Publicidad por Correo',
    'Conference' => 'Conferencia',
    'Trade Show' => 'Feria Comercial',
    'Web Site' => 'Sitio Web',
    'Word of mouth' => 'Boca en boca',
  ...
  array (
    ...
    'New Business' => 'Negocio Nuevo',
  ),
  'roi_type_dom' =>
    array (
    'Revenue' => 'Ganancia',
    'Investment'=>'Inversión',
    'Expected_Revenue'=>'Ganancia Esperada',
    'Budget'=>'Presupuesto',
...
//       it is the key for the default opportunity_relationship_type_dom value
  ...
  array (
    '' => '',
    'Primary Decision Maker' => 'Principal Responsable de Decisiones',
    'Business Decision Maker' => 'Responsable de Decisiones de Negocios',
    'Business Evaluator' => 'Evaluador de Negocios',
    'Technical Decision Maker' => 'Responsable de Decisiones Técnicas',
...
//       it is the key for the default case_relationship_type_dom value
  ...
  'task_status_default' => 'No Comenzada',
  'task_status_dom' =>
  array (
  ...
  'meeting_status_default' => 'Planeada',
  'meeting_status_dom' =>
  array (
    'Planned' => 'Planeada',
    'Held' => 'Llevada a cabo',
  ...
  'call_direction_default' => 'De Salida',
  'call_direction_dom' =>
  array (
    'Inbound' => 'De Entrada',
    'Outbound' => 'De Salida',
...
$app_strings = array (
  ...
  'LBL_JS_CALENDAR' => 'Calendario' /*for 508 compliance fix*/,
    ...
    'LBL_ROUTING_BUTTON_SAVE'               => 'Guardar Rule',
    ...
    'LBL_ROUTING_RE'                        => 'RE: ',
    'LBL_ROUTING_SAVING_RULE'               => 'Guardando Rule',
  ...
  'NTC_OVERWRITE_ADDRESS_PHONE_CONFIRM' => 'This record currently contains values in the Office Teléfono and Address fields. To overwrite these values with the following Office Teléfono and Address of the Account that you selected, click "OK". To keep the current values, click "Cancelar".',
  'LBL_DROP_HERE' => '[Drop Here]',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPPASS'           => 'SMTP Contraseña',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD'      => 'SMTP Contraseña is required',
  ...
  'LBL_EMAIL_ACCOUNTS_OUTBOUND_SUBTITLE'  => 'Provide SMTP mail server information to use for outgoing email in Mail Accounts.',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_ADD'            => 'Terminado',
    'LBL_EMAIL_ADDRESS_BOOK_CLEAR'          => 'Borrar',
    'LBL_EMAIL_ADDRESS_BOOK_ADD_TO'         => 'A:',
    'LBL_EMAIL_ADDRESS_BOOK_ADD_CC'         => 'Cc:',
    'LBL_EMAIL_ADDRESS_BOOK_ADD_BCC'        => 'Bcc:',
    'LBL_EMAIL_ADDRESS_BOOK_ADRRESS_TYPE'   => 'A/Cc/Bcc',
    'LBL_EMAIL_ADDRESS_BOOK_ADD_LIST'       => 'Nueva Lista',
    'LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR'     => 'Dirección de Correo',
    'LBL_EMAIL_ADDRESS_BOOK_ERR_NOT_CONTACT'=> 'Only Contacto editting is supported at this time.',
    'LBL_EMAIL_ADDRESS_BOOK_FILTER'         => 'Filter',
    'LBL_EMAIL_ADDRESS_BOOK_FIRST_NAME'     => 'Nombre/Nombre de la Cuenta',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_NOT_FOUND'      => 'No se Encontraron las Direcciones',
    'LBL_EMAIL_ADDRESS_BOOK_SAVE_AND_ADD'   => 'Guardar & Agregar a la Libreta de Direcciones',
    ...
    'LBL_EMAIL_ADDRESSES_TITLE'             => 'Direcciones de Correo',
    'LBL_EMAIL_ARCHIVE_TO_SUGAR'            => 'Importar to Sugar',
    ...
    'LBL_EMAIL_COMPOSE_SEND_FROM'           => 'Enviar desde el Mail de la Cuenta',
    'LBL_EMAIL_COMPOSE_OPTIONS'             => 'Opciones',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS'     => 'Por favor, ingresa una dirección válida en los campos A, CC y BCC',
  ...
  'LBL_EMAIL_DATE_RECEIVED'               => 'Date Received',
    ...
    'LBL_EMAIL_EDIT_CONTACT'                => 'Edit Contacto',
    'LBL_EMAIL_EDIT_CONTACT_WARN'           => 'Only the Primary address will be used when working with Contactos.',
    ...
    'LBL_EMAIL_IE_DELETE'                   => 'Eliminar la Cuenta de Correo',
    'LBL_EMAIL_IE_DELETE_SIGNATURE'         => 'Eliminación de la Firma',
    'LBL_EMAIL_IE_DELETE_CONFIRM'           => '¿Estás seguro que quieres borrar esta cuenta de correo?',
    'LBL_EMAIL_IE_DELETE_SUCCESSFUL'        => 'Eliminación exitosa.',
    'LBL_EMAIL_IE_SAVE'                     => 'Guardando Información de Cuenta de Correo',
    'LBL_EMAIL_IMPORTING_EMAIL'             => 'Importing Email',
    'LBL_EMAIL_IMPORT_EMAIL'                => 'Importar to Sugar',
    'LBL_EMAIL_IMPORT_SETTINGS'                => 'Importar Settings',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER'        => 'Crear a Folder (remote or in Sugar)',
    ...
    'LBL_EMAIL_MENU_HELP_CONTACT_COMPOSE'   => 'Email this Contacto',
    'LBL_EMAIL_MENU_HELP_CONTACT_REMOVE'    => 'Remove a Contacto',
    'LBL_EMAIL_MENU_HELP_DELETE'            => 'Delete these email(s)',
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER'     => 'Delete a Folder (remote or in Sugar)',
    'LBL_EMAIL_MENU_HELP_EDIT_CONTACT'      => 'Edit a Contacto',
    ...
    'LBL_EMAIL_PERFORMING_TASK'             => 'Performing Tarea',
    ...
    'LBL_EMAIL_QUICK_CREATE'                => 'Quick Crear',
    ...
    'LBL_EMAIL_SAVE_AND_REPLY'              => 'Guardar & Reply',
    'LBL_EMAIL_SAVE_DRAFT'                  => 'Guardar Draft',

    'LBL_EMAIL_SEARCHING'                   => 'Conducting Buscar',
    ...
    'LBL_EMAIL_SEARCH_FULL_TEXT'            => 'Cuerpo de Texto',
    'LBL_EMAIL_SEARCH_NO_RESULTS'           => 'Ningún resultado coincide con los criterios de búsqueda.',
    'LBL_EMAIL_SEARCH_RESULTS_TITLE'        => 'Resultados de la Búsqueda',
    'LBL_EMAIL_SEARCH_TITLE'                => 'Búsqueda Simple',
    'LBL_EMAIL_SEARCH__FROM_ACCOUNTS'       => 'Buscar cuenta de email',
    ...
    'LBL_EMAIL_SETTINGS_AUTO_IMPORT'        => 'Importar Email Upon View',
    ...
    'LBL_EMAIL_SETTINGS_DISPLAY_NUM'        => 'Número de correos por página',
    'LBL_EMAIL_SETTINGS_EDIT_ACCOUNT'       => 'Editar Cuenta de Correo',
    'LBL_EMAIL_SETTINGS_FOLDERS'            => 'Directorios',
    'LBL_EMAIL_SETTINGS_FROM_ADDR'          => 'From Address',
    'LBL_EMAIL_SETTINGS_FROM_TO_EMAIL_ADDR' => 'Dirección de Correo For Test Notification:',
    'LBL_EMAIL_SETTINGS_TO_EMAIL_ADDR'      => 'A Dirección de Correo',
    ...
    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_EDIT' => 'Editar Carpeta de Grupo',
    ...
    'LBL_EMAIL_SETTINGS_SEND_EMAIL_AS'      => 'Send Plain Text Correos Only',
  ...
  'LBL_EMAIL_INVALID_SYSTEM_OUTBOUND' => 'An outgoing mail server is not configured to send emails. Please configure an outgoing mail server or select an outgoing mail server for the mail account that you are using in Settings >> Mail Account.',
    ...
    'LBL_EMAIL_SIGNATURE_NAME'              => 'Firma Name',
    'LBL_EMAIL_SIGNATURE_TEXT'              => 'Firma Body',
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'LBL_EMAIL_IMPORT_SUCCESS'              => 'Importar Passed',
    'LBL_EMAIL_IMPORT_FAIL'                 => 'Importar Failed because either the message is already imported or deleted from server',
    ...
    'LBL_ACCOUNT'=>'Cuenta',
    'LBL_OLD_ACCOUNT_LINK'=>'Antigua Cuenta',
    ...
    'LBL_ADDITIONAL_DETAILS_CLOSE_TITLE' => 'Click to Cerrar',
    'LBL_ADDITIONAL_DETAILS_CLOSE' => 'Cerrar',
    'LBL_ADDITIONAL_DETAILS' => 'Additional Detalles',
    'LBL_ADMIN' => 'Admin',
    'LBL_ALT_HOT_KEY' => '',
    'LBL_ARCHIVE' => 'Archive',
    ...
    'LBL_BILL_TO_CONTACT'=>'Bill to Contacto',
    'LBL_BILLING_ADDRESS'=>'Billing Address',
    'LBL_QUICK_CREATE_TITLE' => 'Quick Crear',
    'LBL_BROWSER_TITLE' => 'SugarCRM - Commercial Open Source CRM',
    'LBL_BUGS'=>'Bugs',
    'LBL_BY' => 'by',
    'LBL_CALLS'=>'Llamadas',
    'LBL_CALL'=>'Llamada',
    'LBL_CAMPAIGNS_SEND_QUEUED' => 'Send Queued Campaña Correos',
    ...
    'LBL_CLOSE_WINDOW'=>'Cerrar Window',
    'LBL_CLOSEALL_BUTTON_KEY' => 'Q',
    'LBL_CLOSEALL_BUTTON_LABEL' => 'Cerrar All',
    'LBL_CLOSEALL_BUTTON_TITLE' => 'Cerrar All',
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => 'Cerrar and Crear New',
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => 'Cerrar and Crear New',
    ...
    'LBL_CONTACT_LIST' => 'Contacto List',
    ...
    'LBL_DST_NEEDS_FIXIN' => 'The application requires a Daylight Saving Time fix to be applied.  Please go to the <a href="index.php?module=Administration&action=DstFix">Repair</a> link in the Admin console and apply the Daylight Guardando Time fix.',
    ...
    'LBL_ID'=>'ID',
    'LBL_IMPORT' => 'Importar',
    'LBL_IMPORT_STARTED' => 'Importar Started: ',
    ...
    'LBL_TODAYS_ACTIVITIES' => 'Hoy\'s Actividades',
    'LBL_LEADS'=>'Leads',
    'LBL_LESS' => 'less',
    ...
    'LBL_THEME_PICKER_IE6COMPAT_CHECK' => 'Warning: Internet Explorer 6 is not supported for the selected theme. Click OK to select it anyways or Cancelar to select a different theme.',
    ...
    'LBL_LIST_CONTACT_ROLE' => 'Contacto Role',
    ...
    'LBL_LISTVIEW_MASS_UPDATE_CONFIRM' => '¿Estás seguro que quieres actualizar toda la lista?',
    'LBL_LISTVIEW_NO_SELECTED' => 'Por favor, seleccione al menos un registro para continuar.',
    'LBL_LISTVIEW_TWO_REQUIRED' => 'Por favor, seleccione al menos 2 registros para continuar.',
    'LBL_LISTVIEW_LESS_THAN_TEN_SELECT' => 'Por favor, seleccione menos de 10 registros para continuar.',
    'LBL_LISTVIEW_ALL' => 'Todo',
    'LBL_LISTVIEW_NONE' => 'Deselecciona Todo',
    'LBL_LISTVIEW_OPTION_CURRENT' => 'Selecciona Esta Página',
    'LBL_LISTVIEW_OPTION_ENTIRE' => 'Selecciona Todo',
    ...
    'LBL_PROJECT_TASKS'=>'Tareas del Proyecto',
    'LBL_PROJECTS'=>'Proyectos',
    'LBL_PROJECTS'=>'Proyectos',
    'LBL_QUOTE_TO_OPPORTUNITY_KEY' => 'O',
    'LBL_QUOTE_TO_OPPORTUNITY_LABEL' => 'Crear Oportunidad from Quote',
    'LBL_QUOTE_TO_OPPORTUNITY_TITLE' => 'Crear Oportunidad from Quote',
    ...
    'LBL_EMAIL_DONE_BUTTON_LABEL' => 'Terminado',
    ...
    'LBL_SAVE_NEW_BUTTON_LABEL' => 'Guardar & Crear Nuevo',
    'LBL_SAVE_NEW_BUTTON_TITLE' => 'Guardar & Crear Nuevo',
    ...
    'LBL_SELECT_TEAMS_LABEL' => 'Agrega Equipo(s)',
    'LBL_SELECT_TEAMS_TITLE' => 'Agrega Equipo(s)',
    ...
    'LBL_SELECT_USER_BUTTON_LABEL' => 'Selecciona Usuario',
    'LBL_SELECT_USER_BUTTON_TITLE' => 'Selecciona Usuario',
    ...
    'LBL_ACCESSKEY_SELECT_FILE_TITLE' => 'Selecciona Archivo',
    'LBL_ACCESSKEY_SELECT_FILE_LABEL' => 'Selecciona Archivo',
    ...
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_TITLE' => 'Select Campaña',
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_LABEL' => 'Select Campaña',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_TITLE' => 'Clear Campaña',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_LABEL' => 'Clear Campaña',
    'LBL_ACCESSKEY_SELECT_CONTACTS_KEY' => 'C',
    'LBL_ACCESSKEY_SELECT_CONTACTS_TITLE' => 'Select Contacto',
    'LBL_ACCESSKEY_SELECT_CONTACTS_LABEL' => 'Select Contacto',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE' => 'Clear Contacto',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_LABEL' => 'Clear Contacto',
    ...
    'LBL_SHIP_TO_CONTACT'=>'Ship to Contacto',
    'LBL_SHIPPING_ADDRESS'=>'Shipping Address',
    'LBL_SHORTCUTS' => 'Shortcuts',
    'LBL_SHOW'=>'Mostrar',
    'LBL_SQS_INDICATOR' => '',
    'LBL_STATE' => 'State:',
    'LBL_STATUS_UPDATED'=>'Tu Estado para este evento ha sido actualizado!',
    'LBL_STATUS'=>'Estado:',
    'LBL_STREET'=>'Calle',
    'LBL_SUBJECT' => 'Título',
    ...
    'LNK_BASIC_SEARCH' => 'Búsqueda Simple',
    'LNK_SEARCH_FTS_VIEW_ALL' => 'Mostrar todos los resultados',
    'LNK_SEARCH_NONFTS_VIEW_ALL' => 'Mostrar Todo',
    'LNK_CLOSE' => 'close',
    'LBL_MODIFY_CURRENT_SEARCH'=> 'Modificar actual búsqueda',
  ...
  'WARN_LICENSE_SEATS_MAXED'=>  "Warning: The number of active users exceeds the maximum number of licenses allowed.",
    ...
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\nClick OK to view this call or click Cancelar to dismiss this message.",
  	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\nClick OK to view this meeting or click Cancelar to dismiss this message.",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "No results found.",
	'MSG_LIST_VIEW_NO_RESULTS' => "No results found for <item1>",
 	'MSG_LIST_VIEW_NO_RESULTS_SUBMSG' => "Crear <item1> as a new <item2>",
    ...
    'LBL_CREATE_CASE' => 'Crear Case',
    'LBL_CREATE_NOTE' => 'Crear Note',
    'LBL_CREATE_OPPORTUNITY' => 'Crear Oportunidad',
    'LBL_SCHEDULE_CALL' => 'Log Llamada',
    'LBL_SCHEDULE_MEETING' => 'Agendar Reunión',
    'LBL_CREATE_TASK' => 'Crear Tarea',
    'LBL_REMOVE_FROM_FAVORITES' => 'Remove From My Favorites',
    //web to lead
    'LBL_GENERATE_WEB_TO_LEAD_FORM' => 'Generate Form',
    'LBL_SAVE_WEB_TO_LEAD_FORM' =>'Guardar Web To Lead Form',
  ...
  'LBL_ALT_ADDRESS' => 'Other Address:',
    ...
    'LBL_SEARCH_RESULTS_FOUND' => 'Resultados de la Búsqueda Found',
...
"5. Click on the Importar option from the Actions menu in the application and choose the file to upload"
   ',
	...
	'MSG_DUPLICATE' => 'The {0} record you are about to create might be a duplicate of an {0} record that already exists. {1} records containing similar names are listed below.<br>Click Crear {1} to continue creating this new {0}, or select an existing {0} listed below.',
    'MSG_SHOW_DUPLICATES' => 'The {0} record you are about to create might be a duplicate of a {0} record that already exists. {1} records containing similar names are listed below.  Click Guardar to continue creating this new {0}, or click Cancelar to return to the module without creating the {0}.',
