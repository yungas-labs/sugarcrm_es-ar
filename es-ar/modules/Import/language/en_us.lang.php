...
$mod_strings = array (
    'LBL_GOOD_FILE' => 'Importar File Read Successfully',
    ...
    'LBL_STEP_4_TITLE' => 'Step {0}: Importar File',
    'LBL_STEP_5_TITLE' => 'Step {0}: View Importar Results',
    ...
    'LBL_IMPORT_BUTTON' => 'Crear new records only',
    'LBL_UPDATE_BUTTON' => 'Crear new records and update existing records',
    ...
    'LBL_IMPORT_ERROR' => 'Importar errors:',
    'LBL_ERROR' => 'Error',
    ...
    'LBL_ERROR' => 'Error:',
    'LBL_IMPORT_ERROR_MAX_REC_LIMIT_REACHED' => 'The import file contains {0} rows. The optimal number of rows is {1}. More rows may slow the import process. Click OK to continue importing. Click Cancelar to revise and re-upload the import file.',
    ...
    'ERR_SELECT_FULL_NAME' => 'You cannot select Full Name when Nombre and Apellido are selected.',
    ...
    'LBL_OUTLOOK_NUM_2' => 'Select the <b>File</b> menu, then the <b>Importar and Exportar ...</b> menu option',
    'LBL_OUTLOOK_NUM_3' => 'Choose <b>Exportar to a file</b> and click Next',
    ...
    'LBL_OUTLOOK_NUM_5' => 'Select the <b>Contactos</b> folder and click <b>Next</b>. You can select different contacts folders if your contacts are stored in multiple folders',
    ...
    'LBL_SF_NUM_3' => '<b>To export Accounts:</b> Click on the <b>Active Accounts</b> link<br><b>To export Contactos:</b> Click on the <b>Mailing List</b> link',
    ...
    'LBL_SF_NUM_9' => 'A report will be generated, and the page will display <b>Report Generation Status: Complete.</b> Now click <b>Exportar to Excel</b>',
    'LBL_SF_NUM_10' => 'On <b>Exportar Report:</b>, for <b>Exportar File Format:</b>, choose <b>Comma Delimited .csv</b>. Click <b>Exportar</b>.',
    ...
    'LBL_ACT_NUM_2' => 'Select the <b>File</b> menu, the <b>Data Exchange</b> menu option, then the <b>Exportar...</b> menu option',
    ...
    'LBL_ACT_NUM_5' => 'Select <b>Contactos records only</b>',
    ...
    'LBL_CUSTOM_NUM_2' => 'Select the <b>Guardar As...</b> or <b>Exportar...</b> menu option',
    'LBL_CUSTOM_NUM_3' => 'Guardar the file in a <b>CSV</b> or <b>Comma Separated Values</b> format',
    ...
    'LBL_TAB_NUM_2' => 'Select the <b>Guardar As...</b> or <b>Exportar...</b> menu option',
    'LBL_TAB_NUM_3' => 'Guardar the file in a <b>TSV</b> or <b>Tab Separated Values</b> format',
    ...
    'LBL_ROW' => 'Row',
    'LBL_SAVE_AS_CUSTOM' => 'Guardar as Custom Mapping:',
    'LBL_SAVE_AS_CUSTOM_NAME' => 'Custom Mapping Name:',
    'LBL_CONTACTS_NOTE_1' => 'Either Apellido or Full Name must be mapped.',
    'LBL_CONTACTS_NOTE_2' => 'If Full Name is mapped, then Nombre and Apellido are ignored.',
    'LBL_CONTACTS_NOTE_3' => 'If Full Name is mapped, then the data in Full Name will be split into Nombre and Apellido when inserted into the database.',
    ...
    'LBL_IMPORT_MORE' => 'Importar Again',
    ...
    'LBL_IMPORT_FIELDDEF_PHONE' => 'Teléfono Number',
    ...
    'LBL_LOCALE_EXAMPLE_NAME_FORMAT' => 'Example',
    'LBL_LOCALE_NAME_FORMAT_DESC' => '<i>"s" Salutation, "f" Nombre, "l" Apellido</i>',
    ...
    'LBL_CONFIRM_IMPORT' => 'You have selected to update records during the import process. Updates made to existing records cannot be undone. However, records created during the import process can be undone (deleted), if desired. Click Cancelar to select to create new records only, or click OK to continue.',
    ...
    'LBL_DUP_HELP' => 'Here are the rows in the import file that were not imported because they contain data that matches values in existing records based on the duplicate check. The data that matches is highlighted. To re-import these rows, download the list, make changes and click <b>Importar Again</b>.',
    'LBL_DESELECT' => 'deselect',
    'LBL_SUMMARY' => 'Summary',
    'LBL_OK' => 'OK',
    'LBL_ERROR_HELP' => 'Here are the rows in the import file that were not imported due to errors. To re-import these rows, download the list, make changes and click <b>Importar Again</b>',
    ...
    'LBL_EXTERNAL_MAP_NOTE' => 'The import will be attempted for contacts within all Google Contactos groups.',
    ...
    'LBL_EXTERNAL_MAP_SUB_HELP' => 'Click <b>Importar Now</b> to begin the import. Records will only be created for entries that include last names. Records will not be created for data identified as duplicate based on names and/or email addresses matching existing records.',
