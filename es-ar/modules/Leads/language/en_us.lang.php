...
$mod_strings = array (
    ...
    'LBL_CONVERTED_CONTACT' => 'Converted Contacto:',
    'LBL_CONVERTED_OPP'=>'Converted Oportunidad:',
    'LBL_CONVERTED'=> 'Converted',
    'LBL_CONVERTLEAD_BUTTON_KEY' => 'V',
    'LBL_CONVERTLEAD_TITLE' => 'Convert Lead',
    'LBL_CONVERTLEAD' => 'Convert Lead',
    'LBL_CONVERTLEAD_WARNING' => 'Warning: The status of the Lead you are about to convert is "Converted". Contacto and/or Account records may already have been created from the Lead. If you wish to continue with converting the Lead, click Guardar. To go back to the Lead without converting it, click Cancelar.',
    'LBL_CONVERTLEAD_WARNING_INTO_RECORD' => ' Possible Contacto: ',
    'LBL_COUNTRY' => 'Country:',
    ...
    'LBL_LIST_NAME' => 'Name',
    'LBL_LIST_PHONE' => 'Office Teléfono',
    ...
    'LBL_NEW_PORTAL_PASSWORD' => 'New Portal Contraseña:',
    'LBL_OFFICE_PHONE' => 'Office Teléfono:',
    'LBL_OPP_NAME' => 'Oportunidad Name:',
    'LBL_OPPORTUNITY_AMOUNT' => 'Oportunidad Amount:',
    ...
    'LBL_PORTAL_PASSWORD_ISSET' => 'Portal Contraseña Is Set:',
    ...
    'LBL_STATUS' => 'Status:',
    'LBL_TITLE' => 'Title:',
    'LNK_IMPORT_VCARD' => 'Crear Lead From vCard',
    ...
    'LBL_TARGET_OF_CAMPAIGNS'=>'Successful Campaña:',
...
//Convert lead tooltips
	...
	'LBL_SELECTION_TIP' => 'Modules with a relate field in Contactos can be selected rather than created during the convert lead process.',
	'LBL_EDIT_TIP'		=> 'Modify the convert layout for this module.',
	'LBL_DELETE_TIP'	=> 'Remove this module from the convert layout.',

    'LBL_ACTIVITIES_MOVE'   => 'Move Actividades to',
    'LBL_ACTIVITIES_COPY'   => 'Copy Actividades to',
    'LBL_ACTIVITIES_MOVE_HELP'   => "Select the record to which to move the Lead's activities. Tareas, Llamadas, Reuniones, Notes and Correos will be moved to the selected record(s).",
    'LBL_ACTIVITIES_COPY_HELP'   => "Select the record(s) for which to create copies of the Lead's activities. New Tareas, Llamadas, Reuniones and Notes will be created for each of the selected record(s). Correos will be related to the selected record(s).",
    //For export labels
    ...
    'LBL_EXPORT_PHONE_MOBILE' => 'Mobile Teléfono',
