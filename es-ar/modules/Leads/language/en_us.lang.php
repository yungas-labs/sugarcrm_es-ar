...
$mod_strings = array (
    ...
    'LBL_CONVERTLEAD_WARNING' => 'Warning: The status of the Lead you are about to convert is "Converted". Contacto and/or Account records may already have been created from the Lead. If you wish to continue with converting the Lead, click Save. To go back to the Lead without converting it, click Cancel.',
...
//Convert lead tooltips
    ...
    'LBL_ACTIVITIES_MOVE_HELP'   => "Select the record to which to move the Lead's activities. Tareas, Calls, Meetings, Notes and Correos will be moved to the selected record(s).",
    'LBL_ACTIVITIES_COPY_HELP'   => "Select the record(s) for which to create copies of the Lead's activities. New Tareas, Calls, Meetings and Notes will be created for each of the selected record(s). Correos will be related to the selected record(s).",
    //For export labels
