...
//END DON'T CONVERT
  ...
  'LBL_OFFICE_PHONE' => 'Office Teléfono:',
  'LBL_ANY_PHONE' => 'Any Teléfono:',
  'LBL_PHONE' => 'Teléfono:',
  'LBL_LAST_NAME' => 'Apellido:',
  'LBL_MOBILE_PHONE' => 'Mobile:',
  'LBL_HOME_PHONE' => 'Home:',
  'LBL_OTHER_PHONE' => 'Other Teléfono:',
  'LBL_FAX_PHONE' => 'Fax:',
  ...
  'LBL_ASSISTANT_PHONE' => 'Assistant Teléfono:',
  'LBL_DO_NOT_CALL' => 'Do Not Llamada:',
  ...
  'MSG_SHOW_DUPLICATES' => 'The target record you are about to create might be a duplicate of a target record that already exists. Target records containing similar names and/or email addresses are listed below.<br>Click Crear Target to continue creating this new target, or select an existing target listed below.',
  'MSG_DUPLICATE' => 'The target record you are about to create might be a duplicate of a target record that already exists. Target records containing similar names and/or email addresses are listed below.<br>Click Guardar to continue creating this new target, or click Cancelar to return to the module without creating the target.',
  'LNK_IMPORT_VCARD' => 'Crear From vCard',
  'LNK_NEW_ACCOUNT' => 'Crear Account',
  ...
  'LNK_NEW_APPOINTMENT' => 'Crear Appointment',
  ...
  'LBL_SAVE_PROSPECT' => 'Guardar Target',
  ...
  'LNK_NEW_CONTACT'=>'New Contacto',
  'LBL_CREATED_CONTACT'=>"Created a new contact",
  'LBL_BACKTO_PROSPECTS'=>'Back to Targets',
  'LBL_CAMPAIGNS'=>'Campaigns',
  'LBL_CAMPAIGN_LIST_SUBPANEL_TITLE'=>'Campaña Log',
  ...
  //For export labels
  'LBL_PHONE_HOME' => 'Teléfono Home',
  'LBL_PHONE_MOBILE' => 'Teléfono Mobile',
  'LBL_PHONE_WORK' => 'Teléfono Work',
  'LBL_PHONE_OTHER' => 'Teléfono Other',
