...
$mod_strings = array(
	...
	'ERR_BAD_LOGIN_PASSWORD'=> 'Login or Contraseña Incorrect',
	...
	'LBL_DELETE_SEEN'		=> 'Delete Read Correos After Importar',
	...
	'LBL_POSSIBLE_ACTION_DESC'		=> 'For the Crear Case option, a Group Folder must be selected',
	...
	'LBL_CREATE_CASE_REPLY_TEMPLATE_HELP' => 'Select an automated response to notify email senders that a case has been created. The email contains the case number in the Título line which adheres to the Case Macro setting.  This response is only sent when the first email is received from the recipient.',
	...
	'LBL_CREATE_CASE'      => 'Crear Case from Email',
	...
	'LBL_ONLY_SINCE'		=> 'Importar Only Since Last Check:',
	'LBL_OUTBOUND_SERVER'	=> 'Outgoing Mail Server',
	'LBL_PASSWORD_CHECK'	=> 'Contraseña Check',
	...
	'LBL_SAVE_RAW'			=> 'Guardar Raw Source',
	...
	'LNK_CREATE_GROUP'		=> 'Crear New Group',
	...
	'LNK_NEW_QUEUES'		=> 'Crear New Queue',
    ...
    'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'When this option is selected, the From Name and From Dirección de Correo associated with this group mail account will appear as an option for the From field when composing emails for users that have access to the group mail account.',
    'LBL_STATUS_ACTIVE'     => 'Active',
    'LBL_STATUS_INACTIVE'   => 'Inactive',
    'LBL_IS_PERSONAL' => 'personal',
    'LBL_IS_GROUP' => 'group',
    'LBL_ENABLE_AUTO_IMPORT' => 'Importar Correos Automatically',
