...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
    ...
    'LBL_WIZARD_FINISH9' => 'Configura la Aplicación ',
    'LBL_WIZARD_FINISH10' => 'Usa Studio para crear y administrar los campos de la aplicación fields y los layouts.',
    'LBL_WIZARD_FINISH11' => 'Visita la Universidad Sugar ',
    'LBL_WIZARD_FINISH12' => 'Encontrar material y clases de entrenamiento que te ayudará a empezar como un administrador de sistema o usuario final de la aplicación.',
    'LBL_WIZARD_FINISH14' => 'Documentación ',
    'LBL_WIZARD_FINISH15' => 'Guias de Producto y Notas de Lanzamiento ',
    'LBL_WIZARD_FINISH16' => 'Base de Conocimiento ',
    'LBL_WIZARD_FINISH17' => 'Trucos del Soporte SugarCRM para el rendimineto de procesos y tareas comunes en Sugar ',
    'LBL_WIZARD_FINISH18' => 'Foro ',
    'LBL_WIZARD_FINISH19' => 'Foro dedicado a la Comunidad Sugar para discutir temas de interes con otros y con desarrolladores SugarCRM ',
    'LBL_WIZARD_FINISH2DESC' => 'Ir directamente a la Página de Inicio de la aplicación.',
    'LBL_WIZARD_PERSONALINFO' => 'Tu Información',
    'LBL_WIZARD_LOCALE' => 'Tu Ubicación',
    'LBL_WIZARD_SMTP' => 'Tu Cuenta de Email',
    'LBL_WIZARD_PERSONALINFO_DESC' => 'Brinda información de ti mismo. La información que brindes acerda de ti será visible para los otros usuarios de Sugar.<br />Los Campor marcados con <span class="required">*</span> son necesarios.',
    'LBL_WIZARD_LOCALE_DESC' => 'Especifica tu zona horaria y como ver Fechas, monedas y nombres que aparecerán en Sugar.',
    'LBL_WIZARD_SMTP_DESC' => 'Brinda nombre de usuario y contraseña de tu cuenta de email para el servidor de correo por defecto.',
	...
	'LBL_THEMEPREVIEW' => 'Previsualizar' /*for 508 compliance fix*/,

    'LBL_OAUTH_TOKENS' => 'OAuth Tokens',
    'LBL_OAUTH_TOKENS_SUBPANEL_TITLE' => "Acceso OAuth Tokens",

    //For export labels
    'LBL_MODIFIED_USER_ID' => 'Usuario ID Modificado',
    'LBL_PHONE_HOME' => 'Teléfono Particular',
    'LBL_PHONE_MOBILE' => 'Teléfono Celular',
