...
$mod_strings = array (
	...
	'ERR_PASSWORD_USERNAME_MISSMATCH'   => 'You must specify a valid User Name and Dirección de Correo.',
	'ERR_PASSWORD_LINK_EXPIRED'         => 'Your link has expired, please generate a new one',
	'ERR_REENTER_PASSWORDS'				=> 'The New Contraseña and Confirm Contraseña values do not match.',
	...
	'LBL_PASSWORD_SENT'                => 'Contraseña Updated',
	...
	'ERR_SMTP_USERNAME_SMTP_PASSWORD'	=> 'SMTP Username and  SMTP Contraseña',
	'ERR_RECIPIENT_EMAIL'				=> 'Recipient Dirección de Correo',
	...
	'LBL_CALENDAR_OPTIONS'				=> 'Calendario Options',
	'LBL_CHANGE_PASSWORD'               => 'Change Generated Contraseña',
	...
	'LBL_FDOW'					=> 'First Day of Semana',
	'LBL_FDOW_TEXT'				=> 'First Day displayed in Semana, Month, and Year Views',
    ...
    'LBL_EMAIL_TEMPLATE_MISSING'            => 'No email template is selected for the email containing the password that will be sent to the user.  Please select an email template in the Contraseña Management page.',
    'LBL_EMPLOYEE_STATUS'				=> 'Employee Status',
    'LBL_EMPLOYEE_INFORMATION'         => 'Employee Information',
	'LBL_ERROR'							=> 'Error',
	'LBL_EXPORT_CHARSET'				=> 'Importar/Exportar Character Set',
    ...
    'LBL_GENERATE_PASSWORD_BUTTON_LABEL'   => 'Reset Contraseña',
    'LBL_GENERATE_PASSWORD_BUTTON_TITLE'   => 'Reset Contraseña',
    'LBL_GENERATE_PASSWORD'             => 'Reset Contraseña',
    ...
    'LBL_LAST_NAME_SLASH_NAME'			=> 'Apellido/Name',
	...
	'LBL_LOCALE_NAME_FORMAT_DESC_2'	=> '<i>"s" Salutation<br>"f" Nombre<br>"l" Apellido</i>',
    ...
    'LBL_LOGIN_FORGOT_PASSWORD'         => 'Forgot Contraseña?',
	...
	'LBL_MODULE_TITLE'					=> 'Usuarios: Home',
    'LBL_NAME'							=> 'Full Name',
	...
	'LBL_NEW_PASSWORD'					=> 'New Contraseña',
	'LBL_NEW_PASSWORD1'					=> 'Contraseña',
	'LBL_NEW_PASSWORD2'					=> 'Confirm Contraseña',
	'LBL_NEW_USER_PASSWORD_1'			=> 'Contraseña was changed successfully.',
	'LBL_NEW_USER_PASSWORD_2'			=> 'An email was sent to the user containing a system-generated password.',
	'LBL_NEW_USER_PASSWORD_3'			=> 'Contraseña was created successfully.',
	...
	'LBL_OLD_PASSWORD'					=> 'Current Contraseña',
	...
	'LBL_PICK_TZ_DESCRIPTION'           => 'Before continuing, please confirm your time zone.  Select the appropriate time zone from the list below, and click Guardar to continue. The time zone can be changed at any time in your user settings.',
	...
	'LBL_PROVIDE_USERNAME_AND_EMAIL' 	=> 'Provide both a User Name and an Dirección de Correo.',
	...
	'LBL_SELECT_CHECKED_BUTTON_LABEL'	=> 'Select Checked Usuarios',
	'LBL_SELECT_CHECKED_BUTTON_TITLE'	=> 'Select Checked Usuarios',
	...
	'LBL_SIGNATURE_PREPEND'				=> 'Firma above reply?',
	...
	'LNK_NEW_PORTAL_USER'				=> 'Crear Portal API User',
	'LNK_NEW_GROUP_USER'				=> 'Crear Group User',
	'LNK_USER_LIST'						=> 'View Usuarios',
    ...
    'LBL_USER_NAME_FOR_ROLE'            =>'Usuarios/Teams/Roles',
...
// INBOUND EMAIL STRINGS
	...
	'LBL_MARK_READ_DESC'				=> 'Importar and mark messages read on mail server; do not delete.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_MAIL_SMTPAUTH_REQ'				=> 'Use SMTP Authentication?',
	'LBL_MAIL_SMTPPASS'					=> 'SMTP Contraseña:',
	'LBL_MAIL_SMTPPORT'					=> 'SMTP Port:',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
    ...
    'LBL_WIZARD_FINISH3' => 'Importar Data ',
    'LBL_WIZARD_FINISH4' => 'Importar data from external sources into the application.',
    'LBL_WIZARD_FINISH5' => 'Crear Usuarios',
    'LBL_WIZARD_FINISH6' => 'Crear new user accounts for people to use to access the application.',
