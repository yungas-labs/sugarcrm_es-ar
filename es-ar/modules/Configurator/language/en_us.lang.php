...
$mod_strings = array (
	...
	'DEFAULT_DATE_FORMAT'=>'Formato de fecha predeterminada',
	'DEFAULT_DECIMAL_SEP'					=> 'Símbolo Decimal',
	'DEFAULT_LANGUAGE'=>'Idioma predeterminado',
	'DEFAULT_NUMBER_GROUPING_SEP'			=> 'Separador de 1000',
	'DEFAULT_SYSTEM_SETTINGS'=>'User Interface',
	'DEFAULT_THEME'=> 'Tema predeterminado',
	'DEFAULT_TIME_FORMAT'=>'Formato de hora predeterminada',
/*	'DISABLE_EXPORT'=>'Disable export',*/
	'DISPLAY_RESPONSE_TIME'=>'Mostrar Tiempo de respuesta del servidor',
	/*'EXPORT'=>'Export',
	'EXPORT_CHARSET' => 'Default Export Character Set',
	'EXPORT_DELIMITER' => 'Export Delimiter',*/
	'IMAGES'=>'Logos',
	'LBL_ADMIN_WIZARD' => 'Asistente de Administración',
	'LBL_ALLOW_USER_TABS' => 'Permitir a los usuarios esconder los separadores',
	'LBL_CONFIGURE_SETTINGS_TITLE' => 'Configuración de Sistema',
	'LBL_ENABLE_MAILMERGE' => 'Habilitar Combinación de Correo?',
	...
	'LBL_CHOOSE_EMAIL_PROVIDER'        => 'Elegi tu proveedor de correo:',
	'LBL_YAHOOMAIL_SMTPPASS'					=> 'Contraseña Yahoo! Mail:',
	'LBL_YAHOOMAIL_SMTPUSER'					=> 'Usuario Yahoo! Mail:',
	'LBL_GMAIL_SMTPPASS'					=> 'Contraseña Gmail:',
	'LBL_GMAIL_SMTPUSER'					=> 'Dirección de Correo Gmail:',
	'LBL_EXCHANGE_SMTPPASS'					=> 'Contraseña Exchange:',
	'LBL_EXCHANGE_SMTPUSER'					=> 'Usuario Exchange:',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP'          => 'Cuando se selecciona esta opción, todos los usuarios podrán enviar correo utilizando la misma cuenta de correo saliente utilizada para enviar las notificaciones y alertas del sistema. Si la opción no está seleccionada, los usuarios pueden utilizar el servidor de correo saliente después de proporcionar la información de su cuenta.',
    ...
    'LBL_LDAP_AUTO_CREATE_USERS'=>'Auto Crear Usuarios:',
	...
	'LBL_LDAP_GROUP_MEMBERSHIP_DESC'=>'Usuarios must be a member of a specific group',
    ...
    'LBL_IMPORT_MAX_RECORDS' => 'Importar - Maximum Number of Rows:',
    ...
    'PDF_SUBJECT' => 'Título',
    'PDF_SUBJECT_INFO' => 'The Título appears in the document properties.',
    ...
    'PDF_USER_PASSWORD' => 'User Contraseña',
    ...
    'PDF_OWNER_PASSWORD' => 'Owner Contraseña',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
    ...
    'LBL_WIZARD_LOCALE_DESC' => 'Specify how you would like data in Sugar to be displayed, based on your geographical location. The settings you provide here will be the default settings. Usuarios will be able set their own preferences.',
    'LBL_WIZARD_SMTP_DESC' => 'Provide the email account that will be used to send emails, such as the assignment notifications and new user passwords. Usuarios will receive emails from Sugar, as sent from the specified email account.',
