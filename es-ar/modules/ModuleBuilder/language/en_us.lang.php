...
'help'=>array(
    ...
    ,
		'defaultquickcreate'=>'The <b>Layout</b> area contains the fields that are currently displayed within the <b>QuickCreate</b> form.<br><br>The QuickCreate form appears in the subpanels for the module when the Crear button is clicked.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
    ,
	...
	'studioWizard'=>array(
		...
		'fieldsBtn'	=> 'Crear and customize <b>Fields</b> to store information in the module.',
	    ...
	    'AdvancedSearchBtn' => 'Customize the <b>Búsqueda Avanzada</b> form that appears in the Búsqueda Avanzada tab in the Search area for the module.',
...
'assistantHelp'=>array(
	...
	'module'=>array(
		...
		'viewlayouts'=>'You can control what fields are available for capturing data within the <b>Edit View</b>.  You can also control what data displays within the <b>Detail View</b>.  The views do not have to match. <br/><br/>The Quick Crear form is displayed when the <b>Crear</b> is clicked in a module subpanel. By default, the <b>Quick Crear</b> form layout is the same as the default <b>Edit View</b> layout. You can customize the Quick Crear form so that it contains less and/or different fields than the Edit View layout. <br><br>You can determine the module security using Layout customization along with <b>Role Management</b>.<br><br>',
...
,
'LBL_POPHELP_GLOBAL_SEARCH'=>'Select to use this field when searching for records using the Búsqueda Global on this module.',
