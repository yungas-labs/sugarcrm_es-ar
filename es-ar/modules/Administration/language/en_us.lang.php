...
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_ACTIVITIES_DESC' =>'Repairs Actividades (Calls, Meetings) end dates',
...
'ML_MANIFEST_ISSUE'=>'Issue with the manifest',
   ...
   'LBL_SELECT_FTS_MODULES_TITLE' => 'Drag and drop to select modules to be used in the Búsqueda Global. Click Save to apply the changes.',
