...
$mod_strings = array (
	...
	'EXPORT_CHARSET' => 'Default Character Set for Importar and Exportar',
    ...
    'ERR_INVALID_LOCALE_NAME_FORMAT_UPGRADE' => 'The "Name Format" that was set before the upgrade is no longer supported.  The format has been automatically set to the default.  Please select a new format and click "Guardar" to remove this message.',
    ...
    'LBL_ADMINISTRATION_HOME_DESC' =>'Configure the system-wide settings according to the specifications of your organization. Usuarios can override some of the default locale settings within their user settings page.',
    ...
    'LBL_CONFIG_FTS' => 'Configure Búsqueda de Texto Completo Engine',
    ...
    'LBL_CONFIGURE_GROUP_TABS_DESC' => 'Crear and edit module menu filters',
    ...
    'LBL_DST_FIX_DONE_DESC' => 'The Daylight Guardando Time fix has been successfully applied.',
    ...
    'LBL_EXPAND_DATABASE_TEXT'=>'This tool allows you to expand selected database columns as an interim fix for multi-byte character limitations in SQL Server. <br>You may choose from three options: <br>Display SQL will display the sql that will be executed on the screen<br> Exportar SQL will export the sql to a file<br> Execute SQL will execute the SQL.',
    'LBL_EXPORT_CUSTOM_FIELDS_TITLE' => 'Exportar Custom Fields Structure',
    'LBL_EXPORT_CUSTOM_FIELDS'=> 'Exportar custom field definitions to a .sugar file',
    ...
    'LBL_LICENSE_NUM_PORTAL_USERS'         => 'Number of Concurrent Self-Service Portal Usuarios',
    'LBL_LICENSE_USERS'      => 'Number of Usuarios',
    ...
    'LBL_LDAP_HELP_TXT'=>'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Sugar Contraseña Management feature settings will apply.',
    ...
    'LBL_LOCALE_NAME_FORMAT_DESC'               => '"s" Salutation<br>"f" Nombre<br>"l" Apellido',
    ...
    'LBL_MANAGE_PASSWORD_TITLE' => 'Contraseña Management',
    ...
    'LBL_MANUAL_VALIDATION4'=>'Step 3:  Transfer the validation key file (sugarvalidationkey.lic) back to the SugarCRM system.  Importar the validation key using this form below: ',
    ...
    'LBL_MASS_EMAIL_MANAGER_HEADER'=>'Campaña Email Management',
    ...
    'LBL_MI_IN_SCHEDULEDTASKS' => 'Installing Scheduled Tareas',
    'LBL_MI_UN_SCHEDULEDTASKS' => 'Uninstalling Scheduled Tareas',
    ...
    'LBL_OOTB_DCE_CLNUP'    => 'Cerrar loop on completed DCE actions',
	'LBL_OOTB_DCE_REPORT'         => 'Crear Action to gather daily reports',
	'LBL_OOTB_DCE_SALES_REPORT'   => 'Crear weekly Sales Report Email',
    'LBL_OVERWRITE_FILES'   => 'Overwrite Files',
    'LBL_PASSWORD_SUGAR_SERVER_DESC'        => '- An Admin user name and password on the server',
    'LBL_PASSWORD_SUGAR_SERVER'          => 'Admin Contraseña:',
    'LBL_PASSWORD'             => 'Contraseña',
    'LBL_PASSWORD_RESET_MANAGEMENT'=> 'Reset password option',
    'LBL_PASSWORD_RULES_MANAGEMENT'=> 'Contraseña Requirements',
	...
	'LBL_PASSWORD_EXP_AFTER'=> 'Contraseña Expires upon',
    'LBL_PASSWORD_FORGOT_FEATURE'=> 'Enable Forgot Contraseña feature',
    ...
    'LBL_PASSWORD_SYST_EXPIRATION'=> 'System-Generated Contraseña Expiration',
    'LBL_PASSWORD_SYST_GENERATED_TITLE'=> 'System-Generated Passwords',
    'LBL_PASSWORD_USER_EXPIRATION'=> 'User-Generated Contraseña Expiration',
	...
	'LBL_PASSWORD_LINK_EXPIRATION_HELP'=> 'A link is generated by the system and sent to the user to allow the user to access the Reset Contraseña page.',
	'LBL_PASSWORD_REGEX'=> 'Regex Requirement',
    'LBL_PASSWORD_REGEX_COMMENT'=> 'Regex Description',
    'LBL_PASSWORD_RULES' => 'Contraseña Rules',
    'LBL_PASSWORD_LINK_EXP_IN'=> 'Link Expires in',
    'LBL_PASSWORD_EXP_IN'=> 'Contraseña Expires in',
    'LBL_PASSWORD_USER_RESET' => 'User Reset Contraseña',
...
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_ACTIVITIES_DESC' =>'Repairs Actividades (Llamadas, Reuniones) end dates',
    'LBL_REPAIR_ACTIVITIES_TEXT'=>'This tool allows you to fix the end date for Llamadas and Reuniones.',
    'LBL_REPAIR_ACTIVITIES' =>'Repair Actividades',
    ...
    'LBL_STATUS'=>'Status ',
    'LBL_TOOLS_DESC' => 'Crear and edit modules and module layouts, manage standard and custom fields and configure tabs. ',
    ...
    'LBL_SUGARFEED_SETTINGS' => 'Actividad Streams',
	'LBL_SUGARFEED_SETTINGS_DESC' => 'Enable the user feed and module feeds for the My Actividad Stream dashlet.',
    ...
    'LBL_UPGRADE_CONVERT_DISC_DESCRIPTION'  => '<b>Warning: Please ensure this is a fresh install with no seed data.</b><br>Enter the following information and press Guardar to convert this system into an offline client.',
    ...
    'LBL_USERS_DESC' => 'Crear, edit, activate and deactivate users in Sugar.',
    ...
    'LNK_NEW_ACCOUNT' => 'Crear an account',
    'LNK_NEW_PRODUCT' => 'Crear Product',
    'LNK_NEW_TEAM' => 'Crear Team',
    'LNK_NEW_USER' => 'Crear New User',
    'LNK_REPAIR_CUSTOM_FIELD' => 'Repair Custom Fields',
    'LNK_SELECT_CUSTOM_FIELD' => 'Select Custom Field',
	'LNK_NEW_PORTAL_USER'				=> 'Crear New Portal User',
	'LNK_NEW_GROUP_USER'				=> 'Crear New Group User',
    ...
    'LBL_CAMPAIGN_CONFIG_TITLE'=>'Campaña Email Settings',
	...
	'LBL_REPAIR_SEED_USERS_TITLE'	=> 'Enable/Disable Seed Usuarios',
...
'ML_MANIFEST_ISSUE'=>'Issue with the manifest',
	...
	'LBL_SAVE_FAILED' => 'Guardar failed.<br/> Please check your file permissions',
	'LBL_SAVING' => 'Guardando...',
	'LBL_ACTIVE_THEMES' => 'Enabled Themes',
	'LBL_DISABLED_THEMES' => 'Disabled Themes',
	'DEFAULT_THEME'=> 'Default theme',
	'LBL_DEFAULT_THEME_IS_DISABLED' => 'The Default Theme you have chosen is disabled. Click "OK" to continue saving the theme changes or "Cancelar" to pick a different default theme.',
   ...
   'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the Sugar Contraseña Management feature settings will apply.',
   ...
   'LBL_SAML_LOGIN_URL_DESC' => 'Enter Login URL',
    ...
    'LBL_GLOBAL_SEARCH_SETTINGS_TITLE' => 'Select the module(s) that users will be able to search against using the Búsqueda Global.',
   ...
   'LBL_SELECT_FTS_MODULES_TITLE' => 'Drag and drop to select modules to be used in the Búsqueda Global. Click Guardar to apply the changes.',
   ...
   'LBL_MI_UN_ACTIONVIEWMAP' => 'Unninstalling Action View Map',
    ...
    'LBL_FTS_SETTINGS_TITLE' => 'Búsqueda de Texto Completo Settings',
    'LBL_FTS_TEST' => 'Test',
    ...
    'LBL_FTS_ADVANCED_LINK_HELP' => 'Select the module(s) that users will be able to search against using the Búsqueda de Texto Completo.',
    ...
    'LBL_FTS_CONNECTION_INVALID' => 'The Búsqueda de Texto Completo Settings you have entered are invalid and may slow down system performance.  Please change or clear your settings.'
);
